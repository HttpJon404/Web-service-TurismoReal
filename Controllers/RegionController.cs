...
namespace WebService.Controllers
{
    public class RegionController : ApiController
    {
        ...
        public async Task<string> GetRegion()
        {
...

            {
                await Task.Run(() => {
                    ...
                    // Crea comando oracle
                    OracleCommand cmd = new OracleCommand("GET_REGION", con);
        ...
        // GET: Region
        [ResponseType(typeof(string))]
        public async Task<string> GetComunasRegion(int id)
        {
            string json = string.Empty;
            try

            {
                await Task.Run(() => {
                    ...
                    // Crea comando oracle
                    OracleCommand cmd = new OracleCommand("GET_COMUNAS_REGION", con);
                    cmd.CommandType = CommandType.StoredProcedure;

                    OracleParameter id_reg =
